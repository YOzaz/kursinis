...
return [
    ...
    // Settings page
    'model_configuration_and_system_parameters' => 'Model configuration and system parameters',
    'my_api_keys' => 'My API Keys',
    'api_keys_info' => 'You can use your personal API keys instead of the system defaults. Your API keys will be securely encrypted and used only for your analyses.',
    'api_key' => 'API Key',
    ...
    'api_keys_updated' => 'API keys successfully updated!',
    'api_key_deleted' => 'API key deleted!',
    'invalid_provider' => 'Invalid provider.',
    'delete_api_key_confirm' => 'Are you sure you want to delete this API key?',
    'model_default_settings' => 'Model default settings',
    'important_settings_info' => 'These settings will affect all new analyses. Existing analyses will remain unaffected. Lower temperature (0.05) ensures more consistent propaganda analysis results.',
    'restore_defaults' => 'Restore defaults',
    'restore_defaults_confirm' => 'Are you sure you want to restore all settings to default values?',
    'settings_updated' => 'Settings successfully updated!',
    'settings_restored' => 'Settings restored to defaults!',
    'error_check_input' => 'Error: Please check your input data.',
    'temperature' => 'Temperature',
    'temperature_tooltip' => 'Controls randomness. Lower values (0.05) - more consistent results, higher - more creative.',
    'max_tokens' => 'Maximum tokens',
    'max_tokens_tooltip' => 'Maximum length of generated response in tokens.',
    'top_p' => 'Top P',
    'top_p_tooltip' => 'Controls word selection diversity. 0.95 recommended for analysis.',
    'top_k' => 'Top K',
    'top_k_tooltip' => 'Limits the number of candidate words (Google models only).',
    'frequency_penalty' => 'Frequency Penalty',
    'frequency_penalty_tooltip' => 'Reduces word repetition (OpenAI models only).',
    'presence_penalty' => 'Presence Penalty',
    'presence_penalty_tooltip' => 'Encourages exploring new topics (OpenAI models only).',
    'models' => 'models',
    ...
    'contact' => 'Contact',
    'contacts' => 'Contacts',
    'contact_system_creators' => 'Contact the system creators',
    'thesis_author' => 'Thesis Author',
    'thesis_author_desc' => 'Thesis author, Data Science',
    'scientific_supervisor' => 'Scientific Supervisor',
    'data_science_dept' => 'Department of Data Science and Digital Technologies',
    'responsible_for' => 'Responsible for',
    'system_architecture_development' => 'System architecture and development',
    'ai_model_integration' => 'AI model integration',
    'risen_methodology_implementation' => 'RISEN methodology implementation',
    'technical_issues_bug_fixes' => 'Technical issues and bug fixes',
    'scientific_methodology' => 'Scientific methodology',
    'atspara_project_coordination' => 'ATSPARA project coordination',
    'academic_consultations' => 'Academic consultations',
    'results_evaluation' => 'Results evaluation',
    'atspara_project' => 'ATSPARA Project',
    'atspara_project_desc' => 'This thesis is based on the ATSPARA project - a Vilnius University initiative dedicated to propaganda and disinformation research in Lithuanian language.',
    'project_website' => 'Project Website',
    'data_sources' => 'Data Sources',
    'annotation_methodology_desc' => 'Annotation methodology and propaganda techniques classification based on ATSPARA corpus research.',
    'academic_research' => 'Academic Research',
    'academic_research_desc' => 'This system was created for academic research purposes. If you have questions about:',
    'research_methodology' => 'Research methodology',
    'research_methodology_desc' => 'and ATSPARA project application',
    'results_interpretation' => 'Results interpretation',
    'results_interpretation_desc' => 'and analysis process specifics',
    'technical_system_operation' => 'Technical system operation',
    'technical_system_operation_desc' => 'and possible issues',
    'data_usage_research' => 'Data usage',
    'data_usage_research_desc' => 'in research context',
    'contact_email_detailed' => 'Please contact via email providing as detailed information about your question as possible.',
    
    // Legal Page
    'legal_information' => 'Legal Information',
    'data_usage_privacy_responsibility' => 'Data usage, privacy and responsibility',
    'general_information' => 'General Information',
    'legal_general_desc' => 'This propaganda analysis system was created for academic research purposes within the framework of Vilnius University Faculty of Mathematics and Informatics master\'s degree program.',
    'institution' => 'Institution',
    'vu_mif_address' => 'Vilnius University<br>Faculty of Mathematics and Informatics<br>Universiteto str. 3, Vilnius',
    'creation_date' => 'Creation Date',
    'thesis_work' => 'Thesis',
    'data_usage_security' => 'Data Usage and Security',
    'what_data_processed' => 'What data is processed:',
    'texts_for_analysis' => 'Texts for analysis',
    'texts_sent_to_ai' => 'Your uploaded texts are sent to AI service providers (OpenAI, Anthropic, Google)',
    'analysis_results_legal' => 'Analysis results',
    'ai_responses_saved' => 'AI model responses are saved in the system database',
    'metadata' => 'Metadata',
    'analysis_time_models_stats' => 'Analysis time, used models, execution statistics',
    'expert_annotations_legal' => 'Expert annotations',
    'if_provided_used_metrics' => 'If provided, used for metrics calculation',
    'how_data_protected' => 'How data is protected:',
    'https_encryption' => 'HTTPS encryption',
    'all_data_transfers_ssl' => 'All data transfers protected by SSL/TLS',
    'university_infrastructure' => 'University infrastructure',
    'servers_under_vu_control' => 'Servers operate under VU control',
    'access_control' => 'Access control',
    'limited_db_access' => 'Limited access to database',
    'api_security' => 'API security',
    'official_api_keys_limited' => 'Official API keys used with limited permissions',
    'important_to_know' => 'Important to know',
    'texts_sent_to_third_party' => 'Your texts will be sent to third-party AI services (OpenAI, Anthropic, Google). Although these providers claim not to store data long-term, we recommend not using confidential or personal data.',
    'gdpr_privacy_protection' => 'GDPR and Privacy Protection',
    'your_rights' => 'Your rights:',
    'access_right' => 'Access right',
    'request_info_stored_data' => 'You can request information about stored data',
    'rectification_right' => 'Rectification right',
    'request_correct_incorrect_data' => 'You can request to correct incorrect data',
    'erasure_right' => 'Erasure right',
    'request_delete_data' => 'You can request to delete your data',
    'portability_right' => 'Portability right',
    'get_data_structured_format' => 'You can get data in structured format',
    'data_retention_period' => 'Data retention period:',
    'analysis_results_retention' => 'Analysis results',
    'stored_until_system_end' => 'Stored until system end (academic work submission)',
    'log_records' => 'Log records',
    '30_day_retention' => '30 day retention period',
    'error_information' => 'Error information',
    'deleted_after_resolution' => 'Deleted after problem resolution',
    'data_controller' => 'Data Controller',
    'data_controller_vu' => 'Vilnius University',
    'contact_legal' => 'Contact',
    'liability_disclaimer' => 'Liability Disclaimer',
    'important_legal' => 'Important',
    'academic_product_not_commercial' => 'This system is an academic research product and is not intended for commercial use. AI results may be inaccurate or biased.',
    'system_limitations' => 'System limitations:',
    'accuracy' => 'Accuracy',
    'ai_not_100_accurate' => 'AI models are not 100% accurate',
    'bias' => 'Bias',
    'models_may_have_bias' => 'Models may have cultural or linguistic biases',
    'context' => 'Context',
    'ai_may_not_understand_context' => 'AI may not understand complex cultural context',
    'stability' => 'Stability',
    'prototype_may_be_unstable' => 'As a prototype, the system may operate unstably',
    'not_responsible_for' => 'We are not responsible for:',
    'incorrect_ai_results' => 'Incorrect AI analysis results',
    'system_failure_data_loss' => 'System failure or data loss',
    'third_party_actions' => 'Third party (AI provider) actions',
    'decisions_based_on_results' => 'Decisions made based on system results',
    'academic_ethics_principles' => 'Academic Ethics Principles',
    'research_ethics' => 'Research ethics:',
    'transparency' => 'Transparency',
    'methodology_code_open' => 'Methodology and code are open for review',
    'objectivity' => 'Objectivity',
    'effort_avoid_bias' => 'Effort to avoid bias in analysis',
    'adherence' => 'Adherence',
    'following_atspara_methodology' => 'carefully following ATSPARA project methodology',
    'academic_freedom' => 'Academic freedom',
    'results_presented_unchanged' => 'Results are presented without modification',
    'citation_usage' => 'Citation and usage:',
    'can_use_for_academic' => 'System can be used for academic purposes',
    'please_cite_atspara' => 'Please cite ATSPARA project and this work',
    'commercial_use_permission' => 'Commercial use requires separate permission',
    'recommended_citation' => 'Recommended citation:',
    'citation_text' => 'Plančiūnas, M. (2025). Propaganda analysis system using RISEN methodology and ATSPARA corpus. Thesis. Vilnius University.',
    'question_resolution' => 'Question Resolution',
    'questions_about_data' => 'If you have questions about data usage, privacy or system operation:',
