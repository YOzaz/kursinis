...
return [
    ...
    // Settings page
    'model_configuration_and_system_parameters' => 'Modelių konfigūracija ir sistemos parametrai',
    'my_api_keys' => 'Mano API raktai',
    'api_keys_info' => 'Galite naudoti savo asmeninius API raktus vietoj sistemos numatytųjų. Jūsų API raktai bus saugiai užšifruoti ir naudojami tik jūsų analizėms.',
    'api_key' => 'API raktas',
    'configured' => 'Sukonfigūruotas',
    'enter_api_key' => 'Įveskite API raktą',
    'save_api_keys' => 'Išsaugoti API raktus',
    'last_used' => 'Paskutinį kartą naudotas',
    'user_not_found' => 'Vartotojas nerastas.',
    'api_keys_updated' => 'API raktai sėkmingai atnaujinti!',
    'api_key_deleted' => 'API raktas pašalintas!',
    'invalid_provider' => 'Netinkamas tiekėjas.',
    'delete_api_key_confirm' => 'Ar tikrai norite pašalinti šį API raktą?',
    'model_default_settings' => 'Modelių numatytosios nuostatos',
    'important_settings_info' => 'Šie nustatymai paveiks visas naujas analizes. Esančios analizės išliks nepaveiktos. Žemesnė temperatūra (0.05) užtikrina nuoseklesnius propagandos analizės rezultatus.',
    'restore_defaults' => 'Atkurti numatytuosius',
    'restore_defaults_confirm' => 'Ar tikrai norite grąžinti visas nuostatas į pradinius nustatymus?',
    'settings_updated' => 'Numatytosios nuostatos sėkmingai atnaujintos!',
    'settings_restored' => 'Nuostatos grąžintos į pradinius nustatymus!',
    'error_check_input' => 'Klaida: Patikrinkite įvesties duomenis.',
    'temperature' => 'Temperatūra',
    'temperature_tooltip' => 'Kontroliuoja atsitiktinumą. Žemesnės reikšmės (0.05) - nuoseklesni rezultatai, aukštesnės - kūrybiškesni.',
    'max_tokens' => 'Maksimalūs tokenai',
    'max_tokens_tooltip' => 'Maksimalus generuojamo atsakymo ilgis tokenais.',
    'top_p' => 'Top P',
    'top_p_tooltip' => 'Kontroliuoja žodžių pasirinkimo įvairovę. 0.95 rekomenduojama analizei.',
    'top_k' => 'Top K',
    'top_k_tooltip' => 'Riboja kandidatų žodžių skaičių (tik Google modeliams).',
    'frequency_penalty' => 'Frequency Penalty',
    'frequency_penalty_tooltip' => 'Mažina žodžių kartojimą (tik OpenAI modeliams).',
    'presence_penalty' => 'Presence Penalty',
    'presence_penalty_tooltip' => 'Skatina naujų temų apsvarstymą (tik OpenAI modeliams).',
    'models' => 'modeliai',
