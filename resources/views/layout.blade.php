        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('home') ? 'active' : '' }}" href="{{ route('home') }}" title="{{ __('messages.dashboard') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('analyses.*') ? 'active' : '' }}" href="{{ route('analyses.index') }}" title="{{ __('messages.analyses') }}">
                            <i class="fas fa-list me-1"></i>{{ __('messages.analyses') }}
                        </a>
                    </li>
                    <li class="nav-item">
